        ...
        child: Column(
          ...
          children: [
            ...
            switchSettingView(
                ...
                text: "Estilos informales",
                inicial: Values().mostrarGatos.value),
            const Divider(),
            switchSettingView(
                onChange: onChangeTheme,
                text: "Fondo simple",
                inicial: Values().fondoSimple.value),
            const Divider(),
            switchSettingView(
                onChange: onChangeFiguraAbajo,
                text: "Ola inferior",
                inicial: Values().figuraAbajo.value),
            const Divider(),
            textBoxSettingView(
                title: "Moneda",
                placeholder: "Divisa",
