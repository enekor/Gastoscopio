          ...
          Expanded(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return CardButton(
                  onPressed: () => navigateInfo(cuentas[index]),
                  child: Column(
                    children: [
                      Expanded(
                        flex: 8,
                        child: SvgPicture.asset(
                          ...
                          //theme: SvgTheme(currentColor: HexColor(cuentas[index].color)),
                          color: HexColor(cuentas[index].color.value),
                        ),
                      ),
                      Expanded(
                          flex: 2, child: Text(cuentas[index].Nombre.value))
                    ],
                  ),
                  childHold: Container(
                  ...
                  onPressOnHold: () => onDelete(cuentas[index]),
                  context: context,
                );
              },
            ),
